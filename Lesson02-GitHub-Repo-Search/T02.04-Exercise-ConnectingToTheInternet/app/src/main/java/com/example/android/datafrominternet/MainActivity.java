...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        try {
            String mSearchResultsTextViewText = NetworkUtils.getResponseFromHttpUrl(githubSearchUrl).toString();
            mSearchResultsTextView.setText(mSearchResultsTextViewText);
        } catch (IOException e) {
            e.printStackTrace();
        }
